...
r = popt[0]
print(f"Original Estimated R0: {r: .2f}")

sigma = 0.0833   # replace with your actual best_sigma
gamma = 0.0909   # replace with your actual best_gamma

R0_reestimated = (1 + r / sigma) * (1 + r / gamma)

print(f"Growth rate r:        {r:.4f} per day")
print(f"Re-estimated R0:      {R0_reestimated:.2f}")
